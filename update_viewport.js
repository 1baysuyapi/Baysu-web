...
indexHtml = indexHtml.replace(/<meta name="viewport" content="width=device-width, initial-scale=1\.0"\s*\/>/, '<meta name="viewport" content="width=1200" />');
...
while ((match = regex.exec(dataJs)) !== null) {
    ...
    if (html.includes('<meta name="viewport" content="width=device-width, initial-scale=1.0" />')) {
        html = html.replace(/<meta name="viewport" content="width=device-width, initial-scale=1\.0"\s*\/>/g, '<meta name="viewport" content="width=1200" />');
...
console.log(`Replaced viewport in index.html and ${replacements.length} pages in data.js`);
